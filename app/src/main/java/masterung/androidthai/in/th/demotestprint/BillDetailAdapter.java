...
public class BillDetailAdapter extends RecyclerView.Adapter<BillDetailAdapter.BillDetailViewHolder> {
    ...
    private ArrayList<String> nameStringArrayList,
            detailStringArrayList, amountStringArrayList, billStringArrayList,
            priceStringArrayList;
    private LayoutInflater layoutInflater;

    public BillDetailAdapter(Context context, ArrayList<String> nameStringArrayList, ArrayList<String> detailStringArrayList, ArrayList<String> amountStringArrayList, ArrayList<String> billStringArrayList, ArrayList<String> priceStringArrayList) {
